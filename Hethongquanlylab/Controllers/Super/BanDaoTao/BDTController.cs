...
namespace Hethongquanlylab.Controllers.Super.BanDaoTao
{
    public class BDTController : Controller
    {
        ...
        public IActionResult Member()
        {
            ...
            List<Member> members;
            if (memberList.Field == "PT")
                members = UserDAO.Instance.GetListUser_Excel("PT");
            else if (memberList.Field == "BĐT")
        ...
        {
            List<Member> members = UserDAO.Instance.GetListUser_Excel(unit);
        ...
        public IActionResult AddMember()
        {
            ...
            return View("./Views/BDT/AddMember.cshtml", avt);
        }
        ...
        public IActionResult UploadAvt(IFormFile file, [FromServices] IWebHostEnvironment hostingEnvironment)
        {
            ...
            return RedirectToAction("AddMember", "BDT", new { avt = file.FileName });
        }
        ...
        public IActionResult ProcedureDetail()
        {
            ...
            return View("./Views/BDT/ProcedureDetail.cshtml", procedure);
        }
        ...
        {
            return View("./Views/BDT/AddProcedure.cshtml", "BanNhanSu");
        }
        ...
        public IActionResult SendProceduresToApproval()
        {
            ...
            return View("./Views/BDT/SendProceduresToApproval.cshtml", procedureList);
        }
