...
namespace Hethongquanlylab.Controllers.Super.BanDaoTao
{
    public class BDHController : Controller
    {
        public IActionResult Index()
        {
            ...
            return View("./Views/BDH/BDHHome.cshtml", itemList);
        }
        ...
        public IActionResult NotificationDetail()
        {
            ...
            return View("./Views/BDH/Detail/NotificationDetail.cshtml", notification);
        }
        ...
        {
            return RedirectToAction("Member", "BDH", new { sort = sortOrder, searchField = searchField, searchString = searchString, page = currentPage });
        }
        ...
        {
            return View("./Views/BDH/Add/AddMember.cshtml");
        }
        ...
        {
            return View("./Views/BDH/Add/AddProcedure.cshtml");
        }
        ...
        public IActionResult ExportProcedureToExcel()
        {
            ...
            using (var excelPackage = new ExcelPackage(memoryStream))
            {
                var worksheet = excelPackage.Workbook.Worksheets.Add("Danh sách quy trình Ban Điều hành");
                var currentRow = 1;
                // trỏ đến dòng 1 và cột 1 thay giá trị bằng LabID các dòng dưới cx tương tự
